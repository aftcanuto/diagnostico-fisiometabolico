-- 037 - Revogacao auditavel de aceite e reforco da anamnese pre-atendimento
...
create index if not exists idx_consentimento_aceites_revogado
  on public.consentimento_aceites(paciente_id, revogado, aceito_em desc);

alter table public.paciente_anamnese_respostas
...
drop policy if exists "consentimento_aceites_clinica_update" on public.consentimento_aceites;
create policy "consentimento_aceites_clinica_update" on public.consentimento_aceites
